...
function App() {
  const stripePromise = loadStripe(
    "pk_test_51OzaX6SDknmPB7a9gyw0taDBaOqjompYteiMeaE0xpS6Q3wLWI7w6RD5wh8dyohpJWTyAan0WBmsOls6dFCfculB00hCCVjc6J"
  );
  ...
  const router = createBrowserRouter(
    ...
    createRoutesFromElements(
      //defines a Route component that matches all paths "/" and renders the main components
  ...
  return (
    <div className="App">
      {/* This ensure that the routing funtionality is available throughout the application  */}
